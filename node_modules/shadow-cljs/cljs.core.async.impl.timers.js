...
var i_14164 = (0);
while(true){
if((i_14164 < arr.length)){
(arr[i_14164] = null);

var G__14165 = (i_14164 + (1));
i_14164 = G__14165;
continue;
} else {
}
...
var i_14180 = (self__.level + (1));
while(true){
if((i_14180 <= (new_level + (1)))){
(update[i_14180] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14183 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14183[i]));
} else {
x__$2.forward.push((((i < links_14183.length))?(links_14183[i]):null));
}

if((i < links_14183.length)){
(links_14183[i] = x__$2);
} else {
links_14183.push(x__$2);
}
...
if((x__$1 === (((i_14186 < links_14187.length))?(links_14187[i_14186]):null))){
