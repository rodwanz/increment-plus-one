...
while(true){
if((i <= self__.level)){
var links_14292 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14292[i]));
} else {
x__$2.forward.push((((i < links_14292.length))?(links_14292[i]):null));
}

if((i < links_14292.length)){
(links_14292[i] = x__$2);
} else {
links_14292.push(x__$2);
}
...
var i_14297 = (0);
while(true){
if((i_14297 <= self__.level)){
var links_14298 = (update[i_14297]).forward;
if((x__$1 === (((i_14297 < links_14298.length))?(links_14298[i_14297]):null))){
(links_14298[i_14297] = (x__$1.forward[i_14297]));

var G__14299 = (i_14297 + (1));
i_14297 = G__14299;
continue;
} else {
var G__14300 = (i_14297 + (1));
i_14297 = G__14300;
continue;
}
} else {
