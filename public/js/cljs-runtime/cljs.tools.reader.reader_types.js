...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12732 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12732(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12733 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12733(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12734 = (function (reader,ch){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12734(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12735 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12735(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12740 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12740(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12748 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12748(reader);
}
});
