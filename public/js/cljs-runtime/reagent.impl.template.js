...
var G__12778 = o;
reagent.impl.template.goog$module$goog$object.set(G__12778,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12862__i < G__12862__a.length) {G__12862__a[G__12862__i] = arguments[G__12862__i + 0]; ++G__12862__i;}
  args = new cljs.core.IndexedSeq(G__12862__a,0,null);
} 
...
var G__12779 = o;
reagent.impl.template.goog$module$goog$object.set(G__12779,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__12869__i < G__12869__a.length) {G__12869__a[G__12869__i] = arguments[G__12869__i + 0]; ++G__12869__i;}
  args = new cljs.core.IndexedSeq(G__12869__a,0,null);
} 
...
var G__12790 = props;
var G__12790__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12790,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12790);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12790__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12795 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12795,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12795;
}
})(),id_class);
...
var G__12799 = (cljs.core.count(argv) - first_child);
switch (G__12799) {
case (0):
...
var vec__12803 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12803,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12803,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12803,(2),null);
...
var temp__5827__auto___12890 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___12890 == null)){
} else {
var key_12891 = temp__5827__auto___12890;
...
var temp__5827__auto___12896 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___12896 == null)){
} else {
var key_12897 = temp__5827__auto___12896;
(jsprops.key = key_12897);
}
...
var temp__5827__auto___12902 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___12902 == null)){
} else {
var key_12907 = temp__5827__auto___12902;
(jsprops.key = key_12907);
}
...
var temp__5827__auto___12909 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___12909 == null)){
} else {
var key_12910 = temp__5827__auto___12909;
(jsprops.key = key_12910);
}
...
var temp__5827__auto___12911 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___12911 == null)){
} else {
var key_12912 = temp__5827__auto___12911;
(jsprops.key = key_12912);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12825_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12825_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12832 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12832,(1),null);
...
break;
default:
var G__12918 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12919 = compiler;
v = G__12918;
compiler = G__12919;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12847 = (function (opts,id,fn_to_element,parse_fn,meta12848){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12847.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12849,meta12848__$1){
var self__ = this;
var _12849__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12847(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12848__$1));
}));

(reagent.impl.template.t_reagent$impl$template12847.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12849){
var self__ = this;
var _12849__$1 = this;
return self__.meta12848;
}));

(reagent.impl.template.t_reagent$impl$template12847.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12847.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12847.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12847.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12847.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12847.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12848","meta12848",346069408,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12847.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12847.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12847");

(reagent.impl.template.t_reagent$impl$template12847.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template12847");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12847.
 */
reagent.impl.template.__GT_t_reagent$impl$template12847 = (function reagent$impl$template$__GT_t_reagent$impl$template12847(opts,id,fn_to_element,parse_fn,meta12848){
return (new reagent.impl.template.t_reagent$impl$template12847(opts,id,fn_to_element,parse_fn,meta12848));
});
...
return (new reagent.impl.template.t_reagent$impl$template12847(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
